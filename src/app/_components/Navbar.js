...
export default function NavBar({ user, cartItems }) {
  ...
  return (
    <div className="h-16 py-2 px-[4%] sm:px-8 md:px-10 lg:px-12 sticky top-0 left-0 z-[90] w-full bg-white text-gray-600 font-semibold flex items-center justify-between shadow-[0_0_.03px_black_inset]">
      <div className="">
      ...
      <div className="min-w-[60px] lg:py-[1px] lg:px-1 rounded-[1.4rem] lg:rounded-none fixed lg:static top-[20vh] -right-20 font-medium shadow-[-.3px_.3px_1.5px_black_inset] lg:shadow-none duration-300 backdrop-blur-md lg:backdrop-blur-none overflow-hidden lg:overflow-auto flex flex-col lg:flex-row items-center justify-center lg:gap-8" ref={rightBarRef}>
        <Link
          href="/"
          className="w-full text-2xl overflow-hidden flex items-center justify-center drop-shadow-[0_0_3px_white] lg:rounded-lg hover:text-cyan-700 hover:ring-1 ring-cyan-700 hover:bg-cyan-700/20 py-4 lg:py-[12px] lg:px-[18px]"
        >
        ...
        <Link
          href="/dashboard"
          className="w-full text-2xl overflow-hidden flex items-center justify-center drop-shadow-[0_0_3px_white] lg:rounded-lg hover:text-cyan-700 hover:ring-1 ring-cyan-700 hover:bg-cyan-700/20 py-4 lg:py-[13px] lg:px-[18px]"
        >
